...
<!--     <th class="tread">Read</th></tr> -->
    <tr><td colspan="2"><h2 class="ya">야레카 야자</h2> <br class="ya">Dypsis lutescens</td><td></td>
    <td rowspan="4"><img src='<c:url value="/resources/images/야레카야자2.jpg"></c:url>' style="float: right; width: 310px; height: 650;"/></td>
	    <td>   </td><td></td></tr>
	<tr><td class="asdf" style="width: 55px;">습도</td><td><img alt="" src='<c:url value="/resources/images/raindrops.png"></c:url>' style="width: 28px; height: 28px; float: left; border: none;">공중 습도 40~60% <br>높은걸 좋아해요 </td>
	<tr><td class="asdf">온도</td><td><img alt="" src=<c:url value="/resources/images/thermometer.png"></c:url> style="width: 28px; height: 28px; float: left;">21~25°C</td></tr>
		
			<tr><td class="asdf">광요구도</td><td><img alt="" src='<c:url value="/resources/images/sun.png"></c:url>' style="width: 28px; height: 28px; float: left; border-bottom: none;">중간 이상 높은 광도(800~10,000 Lux)<br>창가쪽 자리가 좋아요</td></tr>
		<tr style="border-bottom: none;"><td class="asdf">햇빛</td><td><img alt="" src='<c:url value="/resources/images/raindrops.png"></c:url>' style="width: 28px; height: 28px; float: left;">얍얍ssddddddddds</td></tr>
<!-- 	    <td>작성일</td><td></td></tr> -->
