...
<%--   <h1>${boardBean.id}</h1> --%>
		<input type="button" value="글삭제" id="fcontentDelete" class="btn" >
		<input type="button" value="글수정" class="btn" onclick="location.href='<c:url value="/center/fnoticeImageUpdateForm?num=${boardBean.num}"/>'">
  </c:if>
</c:if>
