...
<article>
<h1>update</h1>
<form action='<c:url value="/center/updateForm"/>' method="post">
...
<input type="button" value="글목록" class="btn" onclick="location.href='<c:url value="/center/updateForm?num=${boardBean.num}"/>'">
</div>
</form>
<div class="clear"></div>
<div id="page_control">
